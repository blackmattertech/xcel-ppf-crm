-- Thread ETag + counts must include rows matched by phone when conversation_key is null or differs,
-- so GET ?conversationKey=919... returns the same set as listMessagesByConversationKey (OR query).
