                  ...
                  <div className="flex flex-col gap-2 md:gap-[8px]">
                    ...
                    <div className="relative h-12 md:h-[48px]">
                      <input
                        ...
                        required
                        className="w-full h-full px-3 md:px-4 lg:px-[16px] bg-[#f2f2f2] border-[0.5px] border-[#e5e5e5] rounded-md md:rounded-[6px] text-sm md:text-[15px] leading-[20px] font-roboto text-[#808080] placeholder:text-[#808080] focus:outline-none focus:ring-2 focus:ring-white/20"
                      />
                    </div>
                  </div>
                </div>
