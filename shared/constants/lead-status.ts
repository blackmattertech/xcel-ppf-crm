...
// DISCARDED can be reached from any status (for wrong numbers, etc.)
export const LEAD_STATUS_FLOW: Record<LeadStatus, LeadStatus[]> = {
  [LEAD_STATUS.NEW]: [LEAD_STATUS.QUALIFIED, LEAD_STATUS.UNQUALIFIED, LEAD_STATUS.DISCARDED],
  [LEAD_STATUS.QUALIFIED]: [LEAD_STATUS.QUOTATION_SHARED, LEAD_STATUS.DISCARDED],
  [LEAD_STATUS.UNQUALIFIED]: [LEAD_STATUS.NEW, LEAD_STATUS.DISCARDED], // Can be requalified
  [LEAD_STATUS.QUOTATION_SHARED]: [LEAD_STATUS.QUOTATION_VIEWED, LEAD_STATUS.QUOTATION_ACCEPTED, LEAD_STATUS.QUOTATION_EXPIRED, LEAD_STATUS.DISCARDED],
  [LEAD_STATUS.QUOTATION_VIEWED]: [LEAD_STATUS.QUOTATION_ACCEPTED, LEAD_STATUS.QUOTATION_EXPIRED, LEAD_STATUS.INTERESTED, LEAD_STATUS.DISCARDED],
  [LEAD_STATUS.QUOTATION_ACCEPTED]: [LEAD_STATUS.INTERESTED, LEAD_STATUS.NEGOTIATION, LEAD_STATUS.DISCARDED],
  [LEAD_STATUS.QUOTATION_EXPIRED]: [LEAD_STATUS.QUOTATION_SHARED, LEAD_STATUS.INTERESTED, LEAD_STATUS.DISCARDED], // Can resend quote
  [LEAD_STATUS.INTERESTED]: [LEAD_STATUS.NEGOTIATION, LEAD_STATUS.DEAL_WON, LEAD_STATUS.LOST, LEAD_STATUS.DISCARDED],
  [LEAD_STATUS.NEGOTIATION]: [LEAD_STATUS.DEAL_WON, LEAD_STATUS.LOST, LEAD_STATUS.INTERESTED, LEAD_STATUS.DISCARDED],
