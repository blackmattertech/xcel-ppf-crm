...
export const LEAD_STATUS_FLOW: Record<LeadStatus, LeadStatus[]> = {
  ...
  [LEAD_STATUS.QUOTATION_SHARED]: [LEAD_STATUS.QUOTATION_VIEWED, LEAD_STATUS.QUOTATION_ACCEPTED, LEAD_STATUS.QUOTATION_EXPIRED, LEAD_STATUS.DEAL_WON, LEAD_STATUS.LOST, LEAD_STATUS.NEGOTIATION],
