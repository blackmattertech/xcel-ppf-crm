...
export default function MobileLoginPage() {
  ...
  return (
    <div className="min-h-screen w-full bg-[#1a1a1a] flex flex-col relative">
      {/* Top Image Section - 60vh with rounded top corners */}
      <div className="relative w-full h-[60vh] overflow-hidden rounded-t-[32px]">
        <Image
      ...
      {/* Dark Background Container with rounded top corners - positioned to overlap image */}
      <div className="absolute bg-[#0b0102] left-0 rounded-t-[40px] top-[60vh] w-full bottom-0" />

      {/* Login Form Section - positioned to overlap image section */}
      <div className="relative z-10 -mt-16 px-[26px] w-full max-w-[360px] mx-auto pb-8">
        <form onSubmit={handleSubmit} className="flex flex-col gap-6">
          <div className="flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-5">
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="relative h-12">
                  <div className="absolute inset-0 bg-white border-[0.5px] border-[#e5e5e5] rounded-[6px]" />
                  <input
                    id="email"
                    type="email"
                    value={email}
            ...
            <div className="h-[0.5px] bg-[#e5e5e5] w-full" />
        ...
        {/* Error Message */}
        {error && (
          <div className="mt-4 p-3 bg-red-500/90 text-white text-sm rounded-lg">
            {error}
          </div>
        )}
      </div>
